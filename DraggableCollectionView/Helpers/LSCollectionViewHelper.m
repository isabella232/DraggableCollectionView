...
{
    if (_dragOnTouch != dragOnTouch) {
        _dragOnTouch = dragOnTouch;

        UILongPressGestureRecognizer* gestureRecognizer = (UILongPressGestureRecognizer*)_longPressGestureRecognizer;
        if (dragOnTouch) {
